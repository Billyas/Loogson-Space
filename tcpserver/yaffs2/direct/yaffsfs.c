...
static yaffsfs_Inode *yaffsfs_HandleToInode(int handle)
{
	...
	if (fd && fd->handleCount > 0 && fd->inodeId >= 0 && fd->inodeId < YAFFSFS_N_HANDLES)
...
static struct yaffs_obj *yaffsfs_FollowLink(struct yaffs_obj *obj, int symDepth, int *loop)
{
	if (obj)
		obj = yaffs_get_equivalent_obj(obj);
	...
	while (obj && obj->variant_type == YAFFS_OBJECT_TYPE_SYMLINK)
    {
		...
		if (yaffsfs_IsPathDivider(*alias))
			...
			obj = yaffsfs_FindObject(NULL,alias,symDepth++,1,NULL,NULL,loop);
		else
			/* Relative to here, so use the parent of the symlink as a start */
			obj = yaffsfs_FindObject(obj->parent,alias,symDepth++,1,NULL,NULL,loop);
	}
...
int yaffs_dump_dev(const YCHAR *path)
{
	...
	if (obj)
	{
		...
		printk(	"\r\n"
				...
				"n_ecc_unfixed............. %d\r\n"
				"n_tags_ecc_fixed.......... %d\r\n"
				"n_tags_ecc_unfixed........ %d\r\n"
				"n_deletions............... %d\r\n"
				"n_unmarked_deletions...... %d\r\n"
				"refresh_count............. %d\r\n"
				"cache_hits................ %d\r\n"
				"tags_used................. %d\r\n"
				"summary_used.............. %d\r\n"
