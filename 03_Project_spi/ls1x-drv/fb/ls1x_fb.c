 ...
 */
    ...
    { 33300, 60,  800,    0,    0,  928,  480,    0,    0,  525, 0x00000101, 0x00000000}, /*"800x480_60.00"*/ /* AT070TN83 V1 */
//  { 29232, 60,  800,    0,    0,  928,  480,    0,    0,  525, 0x00000101, 0x00000000}, /*"800x480_60.00"*/
	{ 29559, 60,  480,  488,  490,  498,  800,  832,  912,  1024, 0x00000301, 0xc0000000}, /*"480x800_60.00"*/ /* WKS43178 */
...
static int LS1x_DC_hw_initialize(LS1x_DC_dev_t *dc)
{
    ...
    #if defined(LS1B)
		divider_int  = LS1B_PLL_FREQUENCY(CPU_XTAL_FREQUENCY);
		divider_int /= (vga_modes[mode].pclk * 1000) / 4;
    #elif defined(LS1C)
		divider_int  = LS1C_PLL_FREQUENCY(CPU_XTAL_FREQUENCY);
	    divider_int /= vga_modes[mode].pclk * 1000;
    #endif
