...
{
    driver_init_t       init_entry;
    driver_open_t       open_entry;
    driver_close_t      close_entry;
    driver_read_t       read_entry;
    driver_write_t      write_entry;
    driver_ioctl_t      ioctl_entry;
} driver_ops_t;
#endif
