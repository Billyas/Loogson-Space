...
C_SRCS += \
../RTT4/components/net/sal/socket/net_netdb.c \
../RTT4/components/net/sal/socket/net_sockets.c

OBJS += \
./RTT4/components/net/sal/socket/net_netdb.o \
./RTT4/components/net/sal/socket/net_sockets.o

C_DEPS += \
./RTT4/components/net/sal/socket/net_netdb.d \
./RTT4/components/net/sal/socket/net_sockets.d

# Each subdirectory must supply rules for building sources it contributes
RTT4/components/net/sal/socket/%.o: ../RTT4/components/net/sal/socket/%.c
	@echo 'Building file: $<'
