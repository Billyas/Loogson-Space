...
C_SRCS += \
../RTT4/components/net/sal/src/sal_socket.c

OBJS += \
./RTT4/components/net/sal/src/sal_socket.o

C_DEPS += \
./RTT4/components/net/sal/src/sal_socket.d

# Each subdirectory must supply rules for building sources it contributes
RTT4/components/net/sal/src/%.o: ../RTT4/components/net/sal/src/%.c
	@echo 'Building file: $<'
