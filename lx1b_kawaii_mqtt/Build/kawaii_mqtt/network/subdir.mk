...
C_SRCS += \
../kawaii_mqtt/network/nettype_tcp.c \
../kawaii_mqtt/network/nettype_tls.c \
../kawaii_mqtt/network/network.c

OBJS += \
./kawaii_mqtt/network/nettype_tcp.o \
./kawaii_mqtt/network/nettype_tls.o \
./kawaii_mqtt/network/network.o

C_DEPS += \
./kawaii_mqtt/network/nettype_tcp.d \
./kawaii_mqtt/network/nettype_tls.d \
./kawaii_mqtt/network/network.d

# Each subdirectory must supply rules for building sources it contributes
kawaii_mqtt/network/%.o: ../kawaii_mqtt/network/%.c
	@echo 'Building file: $<'
