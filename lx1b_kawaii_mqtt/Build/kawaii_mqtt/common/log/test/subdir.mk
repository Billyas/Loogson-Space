...
C_SRCS += \
../kawaii_mqtt/common/log/test/test.c

OBJS += \
./kawaii_mqtt/common/log/test/test.o

C_DEPS += \
./kawaii_mqtt/common/log/test/test.d

# Each subdirectory must supply rules for building sources it contributes
kawaii_mqtt/common/log/test/%.o: ../kawaii_mqtt/common/log/test/%.c
	@echo 'Building file: $<'
