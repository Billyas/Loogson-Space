...
C_SRCS += \
../kawaii_mqtt/common/log/fifo.c \
../kawaii_mqtt/common/log/format.c \
../kawaii_mqtt/common/log/salof.c

OBJS += \
./kawaii_mqtt/common/log/fifo.o \
./kawaii_mqtt/common/log/format.o \
./kawaii_mqtt/common/log/salof.o

C_DEPS += \
./kawaii_mqtt/common/log/fifo.d \
./kawaii_mqtt/common/log/format.d \
./kawaii_mqtt/common/log/salof.d

# Each subdirectory must supply rules for building sources it contributes
kawaii_mqtt/common/log/%.o: ../kawaii_mqtt/common/log/%.c
	@echo 'Building file: $<'
