...
C_SRCS += \
../kawaii_mqtt/test/test.c \
../kawaii_mqtt/test/test_ca.c

OBJS += \
./kawaii_mqtt/test/test.o \
./kawaii_mqtt/test/test_ca.o

C_DEPS += \
./kawaii_mqtt/test/test.d \
./kawaii_mqtt/test/test_ca.d

# Each subdirectory must supply rules for building sources it contributes
kawaii_mqtt/test/%.o: ../kawaii_mqtt/test/%.c
	@echo 'Building file: $<'
