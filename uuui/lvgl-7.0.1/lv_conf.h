...
#define LV_TICK_CUSTOM_INCLUDE  "bsp.h"                     /*Header for the sys time function*/
#define LV_TICK_CUSTOM_SYS_TIME_EXPR (get_clock_ticks())    /*Expression evaluating to current systime in ms*/
 ...
 * 微软雅黑 16/24
 */
#define HZ_MSYH_16              0       /* 一级二级汉字 */
#define HZ_MSYH_3500_16         0       /* 3500个常用字 */
#define HZ_MSYH_24              0       /* 一级二级汉字 */
#define HZ_MSYH_3500_24         0       /* 3500个常用字 */

/*
 * 新宋体 16/24
 */
#define HZ_SIMSUN_16            0       /* 一级二级汉字 */
#define HZ_SIMSUN_3500_16       1       /* 3500个常用字 */
#define HZ_SIMSUN_24            0       /* 一级二级汉字 */
#define HZ_SIMSUN_3500_24       0       /* 3500个常用字 */
...
#define LV_THEME_DEFAULT_FLAG               LV_THEME_MATERIAL_FLAG_DARK // LV_THEME_MATERIAL_FLAG_LIGHT
