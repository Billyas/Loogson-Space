...
void ls1x_initialize_lwip(void)
{
    int added_default = 0;
    ...
    IP4_ADDR(&ipaddr, 192, 168, 1, 123);        /* IP address default setting */
    IP4_ADDR(&netmask, 255, 255 , 255, 0);
    IP4_ADDR(&gateway, 192, 168,    1, 1);
    ...
    IP4_ADDR(&ipaddr, 192, 168, 1, 124);        /* IP address default setting */
    IP4_ADDR(&netmask, 255, 255 , 255, 0);
    IP4_ADDR(&gateway, 192, 168,    1, 1);
...
#endif // #if defined(BSP_USE_GMAC0) || defined(BSP_USE_GMAC1)
