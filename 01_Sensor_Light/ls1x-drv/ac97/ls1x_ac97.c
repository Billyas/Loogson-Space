...
static void AC97_hardware_reset(void)
{
...
STATIC_DRV int LS1x_AC97_initialize(void *dev, void *arg)
{
	...
	AC97_hardware_initialize();             /* Initialize hardware */
    ...
    OSTaskCreate(AC97_DMA12_irq_response_task,      /* 创建响应DMA事件的线程 */
                 NULL,
        #if OS_STK_GROWTH == 1
