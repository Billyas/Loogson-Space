...
#define PCA9557_ADDRESS         0x1C                // pca9557 µØÖ· 0b0011 100

#define PCA9557_BAUDRATE        100000              // pca9557 Í¨ĞÅËÙÂÊ

//-----------------------------------------------------------------------------

#define PCA9557_IN_REG          0x00                // ÊäÈë¼Ä´æÆ÷
#define PCA9557_OUT_REG         0x01                // Êä³ö¼Ä´æÆ÷
#define PCA9557_POL_REG         0x02                // ¼«ĞÔ¼Ä´æÆ÷
#define PCA9557_CFG_REG         0x03                // ÅäÖÃ¼Ä´æÆ÷

/*
 * ÊäÈëÊä³öÒı½Å
 */
#if defined(LS1C)
#define PCA9557_CFG_PINS        0b11100100          // pca9557 ÅäÖÃ¼Ä´æÆ÷
...
#elif defined(LS1B)
#define PCA9557_CFG_PINS        0b01110000          // pca9557 ÅäÖÃ¼Ä´æÆ÷
...
static unsigned char saved_out_reg = 0;      // Êä³ö¼Ä´æÆ÷»º´æÖµ
