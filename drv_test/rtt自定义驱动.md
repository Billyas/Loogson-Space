...
static rt_err_t rt_led_control (rt_device_t dev, rt_uint8_t cmd, void *args)
{
    ...
    {
    case 1:
        gpio_write(led_dev->led_num, 0);
        break;
    case 0:
        gpio_write(led_dev->led_num, 1);
        break;
    }
    return RT_EOK;
}
...
![image-20220430134149026](https://cdn.jsdelivr.net/gh/Billyas/myimg/img/image-20220430134149026.png)